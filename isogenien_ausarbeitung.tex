...
Geschlecht 1 zusmammen mit einem fixen Punkt $O\in E$.

\begin{Definition}[Definiertheit]
  Sei $C$ eine Kurve und $\algK[C]_P$ die Lokalisierung ihres affinen
  Koordinatenrings nach dem Maximalideal $M_P$.
  Wir bezeichnen mit
  \begin{align*}
  ...
  \begin{align*}
    ...
    \frac{f}{g} &\mapsto \ord_P(f) - \ord_P(g)
  \end{align*}
